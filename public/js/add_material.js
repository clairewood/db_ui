...
let addMaterialForm = document.getElementById('add-material-form-ajax'); 
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("materials-table");
    ...
    idCell.innerText = newRow.material_id;
